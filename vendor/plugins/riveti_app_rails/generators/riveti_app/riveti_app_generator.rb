...
class RivetiAppGenerator < Rails::Generator::NamedBase
  ...
  def initialize(runtime_args, runtime_options = {})
    ...
    Rails::Generator::Commands::Create.send   :include,  Riveti::Generator::Commands::Create
    Rails::Generator::Commands::Destroy.send  :include,  Riveti::Generator::Commands::Destroy
    Rails::Generator::Commands::List.send     :include,  Riveti::Generator::Commands::List
  ...
  protected    
    ...
    def banner
      "Usage: #{$0} riveti_app ModelName asset_host [field:type, field:type]"
    end
